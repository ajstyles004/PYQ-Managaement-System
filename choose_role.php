...
// Clear any leftover registration session state so selecting role always shows fresh login/register
$regKeys = ['register_step', 'register_email', 'register_student_id', 'register_sent_at'];
foreach ($regKeys as $k) {
